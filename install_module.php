...
/*
=====================================================
 MWS Multi XFields v1.3 - by MaRZoCHi
-----------------------------------------------------
 http://www.dle.net.tr/
-----------------------------------------------------
...
$module = array(
	...
	'image'	=> "http://img.dle.net.tr/mws/multi_xfields.png",
...
echoheader("<i class=\"icon-check\"></i>" . $module['name'], $lang['m01'] );
...
if ( $_REQUEST['action'] == "install" ) {
	...
	$mod->file( ROOT_DIR. "/install/xml/multi_xfields_102.xml" );
	$mod->close();
